  ...
  <a-flex align="flex-start" justify="space-between" gap="20">
    <a-card class="mt-5 w-full h" :body-style="{ padding: '16px' }">
      <a-flex align="center" justify="space-between">
        <a-typography-text class="font-medium text-xl" style="color: #5c576b"
          >Order Bill</a-typography-text
        >
        <a-typography-text class="font-medium text-base" style="color: #999999"
    ...
    <a-card class="mt-5 w-full" :body-style="{ padding: '16px' }">
      <a-flex align="center" justify="space-between">
        <a-typography-text class="font-medium text-xl" style="color: #5c576b"
          >Bill info</a-typography-text
        >
        <a-typography-text class="font-medium text-base" style="color: #999999"
          >Bill ID : 12092723542</a-typography-text
        >
      </a-flex>
      <a-typography-text class="font-normal text-sm" style="color: #999999"
        >Bill Note<span style="color: red">*</span></a-typography-text
      >
      <a-textarea
        v-model:value="value"
        placeholder="write bill noted here ..."
